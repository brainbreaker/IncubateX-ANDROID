...
public class PostsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.loadUrl("https://friendly-pix.com/feed");
...
//            /**HERE WE ARE USING JAVASCRIPT INJECTION IN THE WEBVIEW TO HIDE THE HEADER AND FOOTER,
//             * TODO: BOTTOM FOOTER IN THE WEBPAGE SOURCE IS NOT HIDING BY THE THIRD JAVASCRIPT FUNCTION, SO CHECK IT**/

//            view.loadUrl("javascript:(function() { " +
//                    "document.getElementsByTagName('footer')[0].style.display='none'; " +
//                    "})()");
//            view.loadUrl("javascript:(function() { " +
//                    "document.getElementsClassByName('bottom-footer')[0].style.visibility='hidden'; " +
//                    "})()");
...
//                Log.e(TAG, "FirebaseUtil.getCurrentUserRef().child(\"following\")"+FirebaseUtil.getCurrentUserRef().child("following").toString());

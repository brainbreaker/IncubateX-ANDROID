package com.google.firebase.samples.apps.friendlypix.will_sdk;
...
import com.google.firebase.samples.apps.friendlypix.R;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		surfaceView.getHolder().addCallback(new SurfaceHolder.Callback(){
			...
			public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
				...
				Bitmap shapeTexture = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher, opts);
				Bitmap fillTexture = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher, opts);

...
import com.google.firebase.samples.apps.friendlypix.drawing.BoardListActivity;
...
public class FeedsActivity extends AppCompatActivity implements PostsFragment.OnPostSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_chat) {
            ...
            Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.arsenic.incubate");
